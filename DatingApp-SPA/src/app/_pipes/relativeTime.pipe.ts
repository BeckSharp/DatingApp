...
export class RelativeTimePipe implements PipeTransform {
  ...
  transform(value: any): any {
    if (value) {
      ...
      Article for pipe - https://codersloth.com/blogs/a-simple-time-ago-pipe-to-display-relative-time-in-angular/
      */

      // const upperLimit = 31536000;
      // if(differenceInSeconds > upperLimit){ return this.datepipe.transform(new Date(value), 'MMM d, y'); }
